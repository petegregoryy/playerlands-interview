...
// --------------------------
const createSaleCountdownTicker = (elementId, saleStartDate, saleEndDate) => {
    ...
    function countDownFunction() {
        let timeLeft = saleEndDate.getTime() - now.getTime();
        ...
        let distanceLeft = displayedTime - (now.getTime() + 1000);
    ...
    function displayMsHHMMSS(currentTime, endTime) {
